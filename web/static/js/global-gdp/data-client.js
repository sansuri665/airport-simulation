    ...
    function normalizeRegionalRows(rows, config) {
      return (rows || []).map((row) => {
        ...
        return {
          ...
          global_equity_price_index: toNumber(row.regional_equity_price_index),
          global_equity_price_return_pct: toNumber(row.regional_equity_price_return_pct),
          global_equity_total_return_pct: toNumber(row.regional_equity_total_return_pct),
          global_equity_total_return_index: toNumber(row.regional_equity_total_return_index),
          global_equity_eps_index: toNumber(row.regional_equity_eps_index),
          global_equity_valuation_pe: toNumber(row.regional_equity_valuation_pe),
          global_sovereign_bond_total_return_index: toNumber(row.regional_sovereign_bond_total_return_index),
          global_sovereign_bond_total_return_pct: toNumber(row.regional_sovereign_bond_total_return_pct),
          regional_household_financial_wealth_index: toNumber(row.regional_household_financial_wealth_index),
          regional_asset_market_impulse_index: toNumber(row.regional_asset_market_impulse_index),

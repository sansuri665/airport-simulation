                ...
                round_record(
                    {
                        ...
                        "input_asset_market_impulse_index": as_float(annual, "input_asset_market_impulse_index", 50.0),
                        "input_household_wealth_consumption_impulse": as_float(annual, "input_household_wealth_consumption_impulse"),
                        "input_real_disposable_income_growth_pct": as_float(annual, "input_real_disposable_income_growth_pct"),
                        "input_equity_price_return_pct": as_float(annual, "input_equity_price_return_pct"),
